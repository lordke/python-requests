...
sched.add_job(initProject, 'interval', seconds=5, start_date='2018-06-22 11:55:00', end_date='2018-06-23 11:30:00',max_instances=3,args=['22680'],)
sched.add_job(initProject,'interval', seconds=5, start_date='2018-06-22 11:55:00', end_date='2018-06-23 11:30:00',max_instances=3,args=['20957'],)
sched.start()
# refresh('19179')
# refresh('19179')
# refresh('19179')
